...
export default function AnimatedHero() {
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-[#faf7ff] via-white to-[#faf7ff] pt-10 pb-20 sm:pt-20 sm:pb-32">
      {/* Animated background gradient blobs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-[#e4d4ff] rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob"></div>
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-8 animate-fade-in-up animation-delay-600">
              <a
                href="#quote-form"
                className="inline-block rounded-lg bg-[#261538] px-8 py-4 text-lg font-semibold text-white shadow-lg hover:bg-[#3b205d] transition-all transform hover:scale-105 animate-pulse-slow"
              >
                Get Your Free Quote
              </a>
            </div>
